...
# AI Workshop Switzerland - Fixed Deployment Script v2
# This script addresses the MIME type and resource loading issues

set -e  # Exit on any error

echo "🚀 Starting AI Workshop Switzerland deployment with fixes..."
...
# Build the project
print_status "Building project with fixes..."
npm run build
