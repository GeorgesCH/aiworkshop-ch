...
export const sendContactConfirmation = functions.https.onCall(async (data, context) => {
  try {
...
export const sendWorkshopBookingConfirmation = functions.https.onCall(async (data, context) => {
  try {
...
export const sendBrochureConfirmation = functions.https.onCall(async (data, context) => {
  try {
...
export const sendDiscoveryCallConfirmation = functions.https.onCall(async (data, context) => {
  try {
